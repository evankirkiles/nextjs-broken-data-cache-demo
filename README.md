...
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------- |
| `NEXT_PUBLIC_SITE_URL`     | The protocol and domain (without the endpoint) under which your on-demand revalidation route handler calls are performed. If you use a custom domain like `mywebsite.com` for your project and perform all on-demand revalidation under this domain, _it can only be that_. You can't use `VERCEL_BRANCH_URL` because the auth token JWT needs to contain inside the same domain as your ISR route handler that performs `revalidateTag`, even if they point to the same deployment—I don't know why, and this seems like it might be something that should be looked at by Vercel. You also can't use `VERCEL_URL` because it points to the latest deployment and, as such, won't have a route handler at the time of build.  | https://my-project-name.vercel.app      |
